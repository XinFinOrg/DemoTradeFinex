<div class="sub_page_wraper">
	<section class="finance_solutions">
		<div class="container">
            <h3>InFactor</h3>
            <br>
            <h4 class="infactor" >Factoring your unpaid invoices becomes easy, transparent and secure
</h4>
		</div>
	</section>
	<section class="global_trade_part finance_solutions_part">
		<div class="container">
            ...
            <br>
                ...
                <h3 class="home-page">What is InFactor?</h3><br>
				...
				<h3 class="home-page">Supplier</h3><br>
                ...
                <h3 class="home-page">Buyer</h3><br>
                ...
                <h3 class="home-page">Financier</h3><br>
                ...
                <p>InFactor is going to implement:</p>
                                            ...
                                            <p><b>Interoperability </b></p><p>Interoperability of systems is a major problem when it comes to financing. InFactor platform is designed to be interoperable with ERP systems and SWIFT banking systems so that data can be fetched automatically onto blockchain for factoring. InFactor will also be interoperable with all compliance systems of buyers/vendors/suppliers making data sharing easier between all participants. Built on XinFin protocol, InFactor will operate smoothly with centralized switching and different kind of data making it interoperable with not only existing legacy systems but the blockchain based platforms too.</p>
                                        
               
                <br>
                <h3 class="home-page">Benefits of InFactor platform</h3><br>
                <div class ="home-page">
		...
		<div class="col-md-8 col-sm-4 col-xs-12 videos_video_wraper">
						<h3 class="home-page">How to get started?</h3> <br>
        <p><b>Suppliers/Buyers/Financiers</b> </p>
        <p>InFactor is an easy to use platform. All those who are looking to sell/discount their invoices or factor the invoices can sign up <a href="http://infactor.io/signup">here.</a><br>
        <br>Or<br><br>
