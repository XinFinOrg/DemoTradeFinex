            ...
            <div class="col-md-12 ">
                <div class="form-group col-md-4">
                    <div class="section-title text-left">
                        <h4 class="mb-20">Total Instruments Value added for Funding</h4><h4 class="mb-20 text-center"><strong><?php echo $total_count ?></strong></h4>
                    </div>
                </div>
                <div class="form-group col-md-4">
                    <div class="section-title text-left">
                        <h4 class="mb-20">Total active Instruments for Funding</h4><h4 class="mb-20 text-center"><strong><?php echo $count ?></strong></h4>
                    </div>
                </div>
                <div class="form-group col-md-4">
                    <div class="section-title text-left">
                        <h4 class="mb-20">Total Value of Trade Instruments  worth USD</h4><h4 class="mb-20 text-center"><strong><?php echo $tot_sum ?></strong></h4>
                    </div>
                </div>
                
                <h3 class="mb-20 text-center">Trade Instruments Live worth USD</h3>
                <div class="form-group col-md-4">
                    <div class="section-title text-center">
